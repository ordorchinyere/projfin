...
!function ($) {
  ...
  var Pages = function Pages() {
    this.VERSION = "4.1.0", this.AUTHOR = "Revox", this.SUPPORT = "support@revox.io", this.pageScrollElement = "html, body", this.$body = $("body"), this.setUserOS(), this.setUserAgent();
  };
  ...
  Pages.prototype.setUserOS = function () {
    ...
    if (requestMethod) requestMethod.call(element);else if (void 0 !== window.ActiveXObject) {
    ...
    function autoHideLi() {
      ...
      if (0 != hMenu.length) {
        ...
        if (hMenu.children("ul").children("li.more").remove(), hMenu.children("ul").children("li").each(function (index) {
          ...
          if ((possibleLi -= extraLiHide) < liCount) for (var wrapper = function (hMenu) {
    ...
    autoHideLi(), $(document).on("click", ".menu-bar > ul > li", function () {
      if (0 != $(this).children("ul").length) if ($(window).width() < 992) {
    ...
    $('[data-init="secondary-sidebar"]').each(function () {
      ...
      $(this).on("click", function (e) {
        ...
        if (menu.hasClass("open")) menu.removeClass("open"), menu.removeAttr("style");else {
          menu.addClass("open");
  ...
  SelectFx.prototype.options = {
    ...
    var el,
        backdrop = this.selEl.querySelector(".cs-backdrop"),
  ...
  Card.VERSION = "1.0.0", Card.prototype.collapse = function () {
    ...
    if (this.$element.hasClass("card-maximized")) this.$element.removeClass("card-maximized"), this.$element.attr("style", ""), $.isFunction(this.options.onRestore) && this.options.onRestore(this);else {
  ...
  $.fn.parallax = function (option) {
    return this.each(function () {
      var $this = $(this),
          ...
          options = $.extend(!0, {}, "object" == _typeof(option) ? option : {}, $this.data());
...
}(window.jQuery), function (global, factory) {
  "object" == ( false ? undefined : _typeof(exports)) && "undefined" != typeof module ? factory() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
  ...
  "undefined" != typeof document && function (callback) {
    ...
    function onInitialPointerMove(e) {
      "html" !== e.target.nodeName.toLowerCase() && (hadKeyboardEvent = !1, document.removeEventListener("mousemove", onInitialPointerMove), document.removeEventListener("mousedown", onInitialPointerMove), document.removeEventListener("mouseup", onInitialPointerMove), document.removeEventListener("pointermove", onInitialPointerMove), document.removeEventListener("pointerdown", onInitialPointerMove), document.removeEventListener("pointerup", onInitialPointerMove), document.removeEventListener("touchmove", onInitialPointerMove), document.removeEventListener("touchstart", onInitialPointerMove), document.removeEventListener("touchend", onInitialPointerMove));
    }

    document.addEventListener("keydown", function (e) {
      isValidFocusTarget(document.activeElement) && addFocusVisibleClass(document.activeElement), hadKeyboardEvent = !0;
    }, !0), document.addEventListener("mousedown", onPointerDown, !0), document.addEventListener("pointerdown", onPointerDown, !0), document.addEventListener("touchstart", onPointerDown, !0), document.addEventListener("focus", function (e) {
      var el, type, tagName;
      ...
      var el;
      isValidFocusTarget(e.target) && e.target.classList.contains("focus-visible") && (hadFocusVisibleRecently = !0, window.clearTimeout(hadFocusVisibleRecentlyTimeout), hadFocusVisibleRecentlyTimeout = window.setTimeout(function () {
        hadFocusVisibleRecently = !1, window.clearTimeout(hadFocusVisibleRecentlyTimeout);
    ...
    }, !0), addInitialPointerMoveListeners(), document.body.classList.add("js-focus-visible");
  });
}), function ($) {
  "use strict";
...
/***/ 2:
/*!*****************************************!*\
  !*** multi ./resources/js/pages.min.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/user/Desktop/Projects/projfin/resources/js/pages.min.js */"./resources/js/pages.min.js");
