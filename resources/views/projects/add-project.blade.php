...
@endsection
@section('section')
    <div class="container py-3" id="addProjectPage">
        <div class="py-4">
            <h2>Add Project</h2>
        </div> 
        <form 
            id="projectForm" 
            action="{{route('add-project-action')}}" 
            method="POST" 
            role="form" 
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group form-group-default">
                        ...
                        <div class="controls">
                            <select name="supervisor_id" class="full-width js-example-basic-single">
                ...
                <div class="col-12 pb-3">
                    <div class="form-group mb-0 form-group-default @error('keywords') has-error @enderror">
                        ...
                        <textarea name="keywords" class="form-control" required value="{{old('keywords')}}"></textarea>
                    </div>
